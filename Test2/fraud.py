...
def getSSQ100():
    ...
    page = urllib2.urlopen(urllib2.Request(site))
    html = page.read()
...
def chooseSSQ():
    hhlist = []
    lhlist = []
    ylhlist = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16', '17',
    ...
    if len(ylhrlist) == 600 and len(yllrlist) == 100:
        ...
        lh = random.randint(0, len(yllrlist))
        lhlist.append(yllrlist[lh-1])
        lh = random.randint(0, 15)
        lhlist.append(ylllist[lh-1])
